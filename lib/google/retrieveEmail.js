...
const getEmail = async ({ from }) => {
  ...
  const mail = await gmailClient.users.messages.get({
    userId: 'me',
  ...
  return atob(mail.data.payload.parts[0].body.data)
}
...
module.exports = { getEmail, getEggHeadEmail, getStreamYardEmail }
